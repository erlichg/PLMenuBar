...
@objc public protocol PLMenuBarDelegate: NSObjectProtocol {
    ...
    @objc optional func menuBar(_ menuBar: PLMenuBarView, didSelectDetail detail: PLMenuDetailComboSectionView, atRow row: Int, Section section: Int, forItemAtIndex index: Int);
...
open class PLMenuBarView: UIView, UITabBarDelegate, UITableViewDelegate, PLMenuDetailComboViewDelegate {
    ...
    open func combo(_ combo: PLMenuDetailComboView, didChange detail:PLMenuDetailComboSectionView, valueAtSection section: Int, Row row: Int) {
    ...
    fileprivate func commInit() {
        ...
        if #available(tvOS 10.0, *), self.traitCollection.userInterfaceStyle == UIUserInterfaceStyle.dark {
            self.detailView.backgroundColor = UIColor(white: 0.2, alpha: 0.8);
        }
